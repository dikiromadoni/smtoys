                                ...
                                <div id="receipt-data">
                                    <div>
                                        <div style="text-align:center;">
                                            <img src="<?php echo base_url(); ?>assets/dist/img/logo.png" style="max-width:200px;" alt="fAaizcell">
                                            <p style="text-align:center; margin-top: -12px;"><strong>Faiz Auto Cell</strong><br>jl. Panca Warga IV Rusun Cipinang Besar Selatan Blok B Lantai Dasar Kel. Cipinang Besar Selatan Kec. Jatinegara Kota Jakarta Timur</p>
                                            <p></p>
                                        </div>
                                        <p>
                                        ...
                                        <table class="table table-striped table-condensed" style="margin-top:10px;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Rp.<?php echo number_format($bayar - $grand_total); ?></td>
                                                </tr>
