                    ...
                    <div id="botbuttons" class="col-xs-12 text-center">
                        <div class="row">
                            <div class="col-xs-6" style="padding: 0;">
                                <a href="#" onclick="paymentManual()" class="btn btn-primary btn-block btn-flat" id="pembayaran">Input Manual Penjualan</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="well well-sm" id="leftdiv">
                                <div id="lefttop" style="margin-bottom:5px;">
                                    ...
                                    <div id="sort">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon">
                                                        ...
                                                        <button type="submit" name="filter" class="">Filter</button>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="ukuran" class="control-label">Cari</label>
                                                <div class="input-group">
                                                    <input class="form-control" name="idbarang" type="text" onkeyup="showResult(this.value)" placeholder="Ketik Nama Barang">
                                                    <div id="hasilcari"></div>
                                                    <span class=" input-group-addon">
                                                        ...
                                                        if (!empty($this->cart->contents())) {
                                                            foreach ($this->cart->contents() as $items) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td align="right">Rp.<?=
                                                                                            $this->fungsi->rupiah($items['price']); ?></td>
                                ...
                                <table id="totaltbl" class="table table-condensed totals" style="margin-bottom:10px;">
                                    <tr class="info">
                                        ...
                                        <td class="text-right" style="font-weight:bold;" colspan="2">
                                            <span id="total">
                                                <span id="count">Rp.<?= $this->fungsi->rupiah($this->cart->total()); ?>
        ...
        <div class="modal-content">
            <div id="datapayment">
                ...
                <div class="modal-body">
                    <form onSubmit="if(!confirm('Pastikan sudah terjadi pembayaran!')){return false;}" action="<?= base_url('index.php/penjualan/transaksi'); ?>" method="POST" id="frm_byr" name="frm_byr">
                        <div class="row">
                            <div class="col-xs-12">
                                <div>
                                    <table id="modaltab" class="table table-bordered table-condensed" style="margin-bottom: 0;">
                                        <tr class="table-secondary">
                                            ...
                                            <td id="mdl" class="text-right">
                                                ...
                                                <span>Rp.<input readonly type="number" id="totalT" name="grandtotal" onfocus="startCalculate()" onblur="stopCalc()" value="<?= $this->cart->total(); ?>" required="">
                                                </span>
                                            </td>
                                        </tr class="table-secondary">
                                        <tr>
                                            ...
                                            <td id="mdl" class="text-right">
                                                <span>Rp.
                                                    <input readonly type="number" id="kembalianT" name="kembalian" onfocus="startCalculate()" onblur="stopCalc()" required="">
                                                </span>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <!-- <input type="number" placeholder="Pembayaran" name="bayar" class="form-control" id="bayarTes" required> -->
                                        </div>
                                        <div class="form-group">
...
<div class="modal fade" id="modalpaymentmanual" role="dialog">
            ...
            <div id="datapayment">
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label for="note"><strong>Nama Barang</strong>
                                            </label>
                                            <input type="text" placeholder="Pembayaran" name="bayar" class="form-control" id="bayar" onfocus="startCalculate()" onblur="stopCalc()" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="pelanggan">Harga</label>
                                            <input type="number" name="pelanggan" placeholder="Masukan harga barang" class="form-control">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label for="paymentManual">Metode Pembayaran</label>
                                            <select id="paymentManual" name="metode" class="form-control" style="width:100%;">
                                                <option value="1">Cash</option>
                                                <option value="2">Transfer</option>
                                            </select>
                                        </div>
                    ...
                    <!-- <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="ukuran" class="control-label">Satuan</label>
                            <div class="input-group">
                                <select class="form-control" name="ukuran">
                                    <?php
                                    foreach ($ukuran as $u) {
...
<script type="text/javascript">
    ...
    function Calculate() {
        // var sc = $('#bayar').val();
        // let s = <?= $this->cart->total(); ?>;

        // console.log(sc);


        let a = <?= $this->cart->total(); ?>;
        let b = <?= $this->cart->total(); ?>;
        let c = $('#diskon').val();
        let d = $('#bayar').val();
    ...
    $(function() {
        $('#rekManual').hide();
        $('#paymentManual').change(function() {
            if ($('#paymentManual').val() == '2') {
                $('#rekManual').show();
                createByJson();
            } else {
                $('#rekManual').hide();
