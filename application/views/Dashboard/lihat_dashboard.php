		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-widget widget-user">
					<div class="widget-user-header"  style="background-color:#08313A;">
						<p style="text-align: center;">
							<span style="font-family: georgia, palatino; font-size: 15pt; color: white;">Selamat datang di Faiz Auto Cell</span>
						</p>
					...
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-sm-4 border-right">
								<div class="description-block">
									<h5 class="description-header">jl. Panca Warga IV Rusun Cipinang Besar Selatan Blok B Lantai Dasar Kel. Cipinang Besar Selatan Kec. Jatinegara Kota Jakarta Timur</h5>
