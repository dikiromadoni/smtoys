...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		<header class="main-header">
			<!-- Logo -->
			<a href="#" class="logo" style="background-color:#08313A; ">
				<!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>F</b>A</span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg" style="background-color:#08313A; "><b>Faiz</b><b> Auto</b> Cell</span>
			</a>
			<!-- Header Navbar: style can be found in header.less -->
			<nav class="navbar navbar-static-top" style="background-color:#08313A;">
				<!-- Sidebar toggle button-->
				<a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
					<span class="sr-only">Toggle navigation</span>
				</a>
				<div class="navbar-custom-menu" style="background-color:#08313A;">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header" style="background-color:#08313A;">
								...
								<!-- Menu Body -->
								<li class="user-body" style="background-color:#08313A;">
									<div class="row">
									</div>
			...
			<section class="sidebar">
				...
				<?php if ($this->session->userdata('akses') == 1) : ?>
					<ul class="sidebar-menu" data-widget="tree">
						<li class="header" style="background-color: black;">MAIN NAVIGATION</li>
						<li>
						...
						<li class="active treeview">
							...
							<ul class="treeview-menu" style="background-color: black;">
								<?php $tahun =  date('Y');
								$bulan =  date('m'); ?>
								<li><a href="<?php echo base_url() ?>index.php/laporan"><i class="fa fa-circle-o"></i>LAPORAN TRANSAKSI</a></li>
